...
firebase_link = firebase.FirebaseApplication("https://class186187-default-rtdb.firebaseio.com/",None)
...
def sendData():
    ...
    put_data = firebase_link.put("/",your_code,hex_string)
    print(put_data)
    get_data()
...
def get_data():
    ...
    get_your_data = firebase_link.get('/',your_code)
    print(get_your_data)
    ...
    get_friends_data = firebase_link.get('/',your_friends_code)
    if(get_friends_data != None):
        print("Data : ",get_friends_data)

        byte_str = bytes.fromhex(get_friends_data)
        original = decrypt('AIN',byte_str)
        final_message = original.decode("uft-8")
...
your_code_label = Label(login_window, text="Your code :  ",
                        font='arial 13', bg='#AB92BF', fg="white")
...
friends_code_label = Label(
    login_window, text="Your Friends code :  ", font='arial 13', bg='#AB92BF', fg="white")
